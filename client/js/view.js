...
function View() {
    ...
    this.appendTrack = function (trackNumber, instrumentName, SAMPLE_HEIGHT) {
        ...
        tr.innerHTML = '<td class="trackBox" style="height : ' + SAMPLE_HEIGHT + 'px"><table width=100%><tr><td width=5%><div align="right">' +
            //"<progress class='pisteProgress' id='progress" + trackNumber + "' value='0' max='100' style='width : " + SAMPLE_HEIGHT + "px' ></progress>" +
            instrumentName + '</div></td>' +
...
"<td width=100%>" +
            "<span id='volspan'><input type='range' class = 'volumeSlider' id='volume" + trackNumber + "' min='-70' max = '0' value='-70' onchange='setVolumeOfTrackDependingOnSliderValue(" + trackNumber + ");'/></span></td></tr></table><td>";
